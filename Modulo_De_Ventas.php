...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="css/estilos_Mod_De_ventas.css">
        <style>
        .linea{
            margin-top: 40px;
    ...
    <body>
        ...
        <img class="img" src="Imag/CAR AUDIO.png" all="">
            <center><h1 class="h1">Modulo De Ventas</h1></center>
        ...
        <nav>
            <ul>
                ...
                <li><a href="#">Mantenimientos y Reparaciones</a></li>
    ...
    <div class="footer"<center><footer>© Todos los derechos reservados 2021</footer></center></div>
</html>